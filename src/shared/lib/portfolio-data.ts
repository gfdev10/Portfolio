  ...
  projects: [
    {
      ...
      description: 'Plataforma de arbitraje financiero.',
    ...
    },
    {
      ...
      description: 'Sitio web premium para salón de estética.',
    ...
    },
    {
      ...
      description: 'App de agendamiento de turnos.',
    ...
    },
    {
      ...
      description: 'Optimización y gestión eficiente de tokens para proyectos de IA.',
      tech: ['React', 'Next.js', 'Web3'],
      liveUrl: 'https://github.com/gfdev10/AI-Optimizer-Token',
      githubUrl: 'https://github.com/gfdev10/AI-Optimizer-Token',
    },
    {
      title: 'IA Free Models',
      category: 'proyecto',
      image: '/img/FreeModelsIA.png',
      description: 'Dashboard para explorar y gestionar modelos de IA gratuitos.',
      tech: ['React', 'Next.js'],
      liveUrl: 'https://free-models-ia-dashboard.vercel.app/',
      githubUrl: 'https://github.com/gfdev10/Free-Models-IA',
    },
  ],
}
