        ...
        <section className="relative min-h-[400px] md:min-h-[500px] flex flex-col justify-center py-10 overflow-hidden">
            ...
            >
                ...
                <motion.p
                    ...
                    className="max-w-3xl text-lg md:text-xl text-muted-foreground leading-relaxed mb-10"
                >
                ...
                <div className="flex flex-wrap gap-4">
                    <motion.button
                        ...
                        className="px-8 py-4 bg-primary text-primary-foreground rounded-2xl font-bold shadow-xl shadow-primary/20 hover:shadow-primary/40 transition-all duration-300"
                    >
                        Explorar Proyectos
                    </motion.button>
                    ...
                    <motion.button
                        ...
                        className="px-8 py-4 glass-effect text-foreground rounded-2xl font-bold hover:bg-white/5 transition-all duration-300"
                    >
                        Contactar
                    </motion.button>
                </div>
